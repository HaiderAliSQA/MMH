...
export const createUser = async (req: any, res: Response): Promise<void> => {
  ...
  try {
    ...
    await Employee.create({
      ...
      annualLeaveTotal: req.body.annualLeaveBalance ?? 10,
      sickLeaveBalance: req.body.sickLeaveBalance ?? 6,
      sickLeaveTotal: req.body.sickLeaveBalance ?? 6,
      emergencyLeaveBalance: req.body.emergencyLeaveBalance ?? 3,
      emergencyLeaveTotal: req.body.emergencyLeaveBalance ?? 3,
      maternityLeaveBalance: req.body.maternityLeaveBalance ?? 30,
      maternityLeaveTotal: req.body.maternityLeaveBalance ?? 30,
      unpaidLeaveBalance: req.body.unpaidLeaveBalance ?? 15,
      unpaidLeaveTotal: req.body.unpaidLeaveBalance ?? 15,
      isActive: isActive ?? true,
    });
